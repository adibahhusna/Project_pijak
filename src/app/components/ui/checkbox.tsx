...
type ChartTooltipContentProps = Omit<
  ...
  "payload" | "label"
> &
  Omit<React.ComponentProps<"div">, "payload" | "label"> & {
    hideLabel?: boolean;
                  ...
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        ...
                        // PERBAIKAN TAILWIND 3: Menggunakan CSS Inline style dinamis bawaan React 
                        // karena class utilities penulisan v4.0 ditolak oleh engine v3
                        style={
                          {
